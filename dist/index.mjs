...
import React5, { useEffect, useState as useState3 } from "react";
// src/components/cards/CommentCard.tsx
import { useState as useState2 } from "react";
import TimeAgo2 from "react-timeago";
...
// src/components/common/MainButton.tsx
var MainButton = forwardRef2(function(param, ref) {
...
function AddCommentSection(param) {
    ...
    var _useState = _sliced_to_array(useState(""), 2), comment = _useState[0], setComment = _useState[1];
    var _useState1 = _sliced_to_array(useState(false), 2), addCommentLoading = _useState1[0], setAddCommentLoading = _useState1[1];
...
function CommentCard(param) {
    ...
    var _useState2 = _sliced_to_array(useState2(false), 2), replyComment = _useState2[0], setReplyComment = _useState2[1];
    var _useState21 = _sliced_to_array(useState2(false), 2), showReply = _useState21[0], setShowReply = _useState21[1];
    var _useState22 = _sliced_to_array(useState2([]), 2), replies = _useState22[0], setReplies = _useState22[1];
    var _useState23 = _sliced_to_array(useState2(false), 2), repliesLoading = _useState23[0], setRepliesLoading = _useState23[1];
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
        ...
        className: "text-xs text-muted-foreground"
    }, /* @__PURE__ */ React.createElement(TimeAgo2, {
        date: comment.createdAt
    }))), /* @__PURE__ */ React.createElement("p", null, comment.content), /* @__PURE__ */ React.createElement("div", {
        className: "flex items-center gap-2"
    }, /* @__PURE__ */ React.createElement(Button, {
...
var CommentSection = function(param) {
    ...
    var _useState3 = _sliced_to_array(useState3(false), 2), isMounted = _useState3[0], setIsMounted = _useState3[1];
    var _useState31 = _sliced_to_array(useState3([]), 2), comments = _useState31[0], setComments = _useState31[1];
    var _useState32 = _sliced_to_array(useState3(0), 2), refreshKey = _useState32[0], setRefreshKey = _useState32[1];
    var _useState33 = _sliced_to_array(useState3(false), 2), commentsLoading = _useState33[0], setCommentLoading = _useState33[1];
    useEffect(function() {
    ...
    return /* @__PURE__ */ React5.createElement("div", {
    ...
    }, /* @__PURE__ */ React5.createElement(AddCommentSection_default, {
        commentRepository: commentRepository,
        setRefreshKey: setRefreshKey
    }), !isMounted && /* @__PURE__ */ React5.createElement("div", null, /* @__PURE__ */ React5.createElement(CommentSkeleton_default, {
        count: 6
        ...
        }, /* @__PURE__ */ React5.createElement(CommentCard_default, {
            comment: comment,
            commentRepository: commentRepository,
            setRefreshKey: setRefreshKey
        }));
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    cached.promise = cached.promise || MongoClient.connect(mongoDBUrl, {}).then(function(client) {
...
export { CommentSection_default as CommentSection, MongoCommentRepository };
